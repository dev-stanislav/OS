...
void app_sproot_start(char **args,uint8_t count){(void)args;(void)count;gfx_init();gfx_clear(0x008080);gfx_rect(0,560,800,40,0x00C0C0C0);gfx_rect(4,564,90,30,0x00E0E0E0);gfx_rect(20,40,210,120,0x00C0C0C0);gfx_border(20,40,210,120,0x00000080);menu=0;draw();}
