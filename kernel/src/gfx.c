...
static const uint8_t *glyph(char c){static const uint8_t colon[5]={0,20,0,20,0},dash[5]={8,8,8,8,0},dot[5]={0,1,1,0,0},slash[5]={1,2,4,8,16},under[5]={1,1,1,1,1},gt[5]={65,34,20,8,0};if(c>='A'&&c<='Z')return font[c-'A'+1];if(c>='a'&&c<='z')return font[c-'a'+1];if(c>='0'&&c<='9')return font[c-'0'+27];if(c==':')return colon;if(c=='-')return dash;if(c=='.')return dot;if(c=='/')return slash;if(c=='_')return under;if(c=='>')return gt;return font[0];}
